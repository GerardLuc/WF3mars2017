...
<html>
	...
	<body>
		...
		<script>
			...
			// sur ajax.php récupérer les informations de l'employes coprrespondant à l'id récupéré
			// et envoyer une réponse sous forme de tableau html. Le tableau doit avoir deux lignes, une avec le noms des colonnes et l'autre avec les valeurs
