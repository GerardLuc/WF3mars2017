<?php
    ...
    // 4- Enregistrement du produit en BDD
        ...
        if($_POST){ // Equivalent à !empty($_POST) car si le $_POST est rempli, il vaut TRUE = formulaire posté
            ...
            executeRequete("REPLACE INTO avis (id_avis, id_membre, id_salle, commentaire)VALUES(:id_avis, :id_membre, :id_salle)", array('id_avis' => $_POST['id_avis'], 'id_membre' => $_POST['id_membre'], 'id_salle' => $_POST['id_salle'], 'commentaire' => $_POST['commentaire'], 'nom' => $_POST['nom']));
