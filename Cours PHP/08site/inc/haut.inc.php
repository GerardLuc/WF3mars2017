...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">    
            <div class="navbar-header">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false" aria-control="navbar" > 
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
                <ul class="nav navbar-nav">
                    ...
                    if (internauteEstConnecte()){
                        ...
                        echo '<li><a href="' . RACINE_SITE . 'connexion.php">Se deconnecter</a></li>';
                    }
    ...
    <div class="container" style="min-height: 80vh; padding-top:100px">
        <!-- Ici contenu specifique de chaque page-->
